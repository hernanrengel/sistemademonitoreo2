    ...
    <div class="row row-offcanvas row-offcanvas-left" style=" padding-top: 20px;">
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" >
            <div class="list-group">
                ...
                <a href="{{ route('ss-uno-cuatro') }}" class="list-group-item" id="activo">Restitución de Bosques</a>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="jumbotron" >                     
                 <h2>RESTITUCIÓN DE BOSQUES</h2><br>
                    <h5>- SUPERFICIE INSCRITA Y ACTIVA (POR TIPO DE PROPIEDAD)
                    </h5>                           
            </div>
        </div>
    </div>
