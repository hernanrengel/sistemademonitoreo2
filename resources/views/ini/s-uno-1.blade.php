    ...
    <div class="row row-offcanvas row-offcanvas-left" style=" padding-top: 20px;">
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" >
            <div class="list-group">
                <a href="{{ route('ss-uno-uno') }}" class="list-group-item" id="activo">Instrumentos de Planificación</a>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="jumbotron" >                     
                 <h2>INSTRUMENTOS DE PLANIFICACIÓN</h2><br>
                    <h5> - PLAN DE ORDENAMIENTO PEDRAL <br>
                        - PLAN GENERAL DE MANEJO FORESTAL <br>
                        - PLAN DE GESTIÓN INTEGRAL DE BOSQUES Y TIERRA
                    </h5>                           
            </div>
        </div>
    </div>
