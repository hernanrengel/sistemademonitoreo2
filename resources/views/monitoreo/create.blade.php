...
<table>
	...
	<?php
		...
		echo '    <input type="button" onclick="cadenaFormulario()" value="cadena">';
		echo '    <input type="button" onclick="graba()" value="Subir cadena">';
		echo '    <input type="button"  id ="ajax" value="Subir cadena AJAX" onclick="enviarjson()">';
